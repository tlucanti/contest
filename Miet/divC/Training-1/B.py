# -*- coding: utf-8 -*-
# @Author: kostya
# @Date:   2021-11-13 17:37:03
# @Last Modified by:   kostya
# @Last Modified time: 2021-11-13 19:58:30
...
def dfs(start, direct):
	start = start + direct
	while start.x >= 0 and start.x <= 1000 and start.y >= 0 and start.y <= 1000:
		# print(' --', start)
...
n = int(input())
drifts = []
MAP = [[None] * 1001 for _j in range(1001)]

for i in range(n):
	snow = point(map(int, input().split()))
	drifts.append(snow)
	MAP[snow.x][snow.y] = 0
